...
Lo podemos obtener en un pequeño script de python.
```python
...
Explicando la mágica línea:
```python
print(chr(int(n, 16)), end='')
# 1. int(n, 16): Recibe un string y lo intenta interpretar como un número entero de base 16.
# 2. chr(int(n, 16)): Convierte el número resultante al caracter ascii correspondiente.
```
